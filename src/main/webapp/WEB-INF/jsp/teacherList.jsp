...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"/teacher/teacherList?t="+new Date().getTime(),
	        idField:'id', 
	    ...
	    function preLoadClazz(){
	  		$("#clazzList").combobox({
		  		...
		  		editable: false, //不可编辑
		  		method: "post",
		  		url: "/clazz/getClazzList?t="+new Date().getTime()+"&from=combox",
	  ...
	  //下拉框通用属性
	  	...
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_photo").attr("src", "/photo/getPhoto?type=2&tid="+selectRow.id);
	...
	function uploadPhoto(){
		...
		setTimeout(function(){
			...
			$("#edit_photo").attr("src", "/photo/getPhoto?tid="+$("#set-photo-id").val());
		}, 1500)
	}
	</script>
</head>
<body>
	...
	<div id="addDialog" style="padding: 10px;">  
   		<div style=" position: absolute; margin-left: 560px; width: 200px; border: 1px solid #EEF4FF" id="photo">
    		<img alt="照片" style="max-width: 200px; max-height: 400px;" title="照片" src="/photo/getPhoto" />
	    </div> 
