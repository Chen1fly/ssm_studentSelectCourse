...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src="/cpacha/loginCapcha?t="+new Date().getTime();;
		});
			...
			$.ajax({
				...
				success: function(msg){
					if("vcodeError" == msg){
						...
						window.location.href = "/system/toAdminView";
					} else{
						alert(msg);
					} 
				}
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="/cpacha/loginCapcha"></div>
      </div>
...
<div class="footer">Copyright &nbsp; artisan @ ssm学生信息管理系统 </div>
