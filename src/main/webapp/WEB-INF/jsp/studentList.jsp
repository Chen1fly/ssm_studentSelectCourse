...
<head>
	...
	$(function() {	
	    ...
	    $("#editDialog").dialog({
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "/student/editStudent?t="+new Date().getTime(),
			...
			onBeforeOpen: function(){
				...
				$("#edit_photo").attr("src", "/photo/getPhoto?type=2&sid="+selectRow.id);
	...
	function uploadPhoto(){
		...
		setTimeout(function(){
			...
			$("#edit_photo").attr("src", "/photo/getPhoto?sid="+$("#set-photo-id").val());
		}, 1500)
	}
	</script>
</head>
