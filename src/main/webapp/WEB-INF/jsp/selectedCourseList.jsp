...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"/selectedCourse/selectedCourseList?t="+new Date().getTime(),
	        idField:'id', 
	    ...
	    function preLoadClazz(){
	  		$("#studentList").combobox({
		  		...
		  		editable: false, //不可编辑
		  		method: "post",
		  		url: "/student/studentList?t="+new Date().getTime()+"&from=combox",
	  		...
	  		$("#courseList").combobox({
		  		...
		  		editable: false, //不可编辑
		  		method: "post",
		  		url: "/course/courseList?t="+new Date().getTime()+"&from=combox",
